...
namespace CompactFormatter.Surrogate
{
	...
	public class DefaultSurrogates
	{
		...
		/// <summary>
		/// Handles the surrogate for GUID's.
		/// </summary>
		/// <param name="t">The t.</param>
		/// <returns><see cref="Object"/></returns>
		[Surrogate(typeof(Guid))]
		public static Object GuidSurrogate(Type t)
		{
			return new Guid();
		}

		[Surrogate(typeof(DBNull))]
		public static Object DBNullSurrogate(Type t)
		{
			return DBNull.Value;
		}

		[Surrogate(typeof(System.Collections.Hashtable))]
		public static Object HashTableSurrogate(Type t)
		{
			return new System.Collections.Hashtable();
		}

		[Surrogate(typeof(System.Collections.ArrayList))]
		public static Object ArrayListSurrogate(Type t)
		{
			return new System.Collections.ArrayList();
		}

		// GMS 10/27/11 - Support for generic collections does not work. Method below could be generally useful
		// so am leaving it here for future reference.
		
		//[Surrogate(typeof(System.Collections.Generic.List<>))]
		...
		//    {
		//        Console.WriteLine("No parameterless constructor available for object {0}", t);
		//        return null;
		//    }
